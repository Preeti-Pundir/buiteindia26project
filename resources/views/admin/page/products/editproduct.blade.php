                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                <div class="tab-pane active" id="general">
                                    <div class="tile">
                                        {{-- {{route('edit.product',['id'=>$product[0]->id])}} --}}
                                        <form action="{{ route('edit.product.update') }}" method="POST" role="form">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    @foreach($product->images as $image)
                                                        <div class="col-md-3">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <img src="{{URL::asset('storage/'.$image->full) }}" id="brandLogo" class="img-fluid" alt="img">
                                ...
                                <div class="tab-pane" id="attributes">
                                    <ProductAttribute data-productid="{{ $product->id }}" >
                            </div>
                        </div>
                    </div>
